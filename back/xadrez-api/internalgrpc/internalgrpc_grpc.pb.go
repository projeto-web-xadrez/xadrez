...
const (
	Internal_RequestRoom_FullMethodName = "/Internal/RequestRoom"
)
...
func (c *internalClient) RequestRoom(ctx context.Context, in *RequestRoomMessage, opts ...grpc.CallOption) (*RoomResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoomResponse)
	err := c.cc.Invoke(ctx, Internal_RequestRoom_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInternalServer) RequestRoom(context.Context, *RequestRoomMessage) (*RoomResponse, error) {
...
func _Internal_RequestRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestRoomMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InternalServer).RequestRoom(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Internal_RequestRoom_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InternalServer).RequestRoom(ctx, req.(*RequestRoomMessage))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Internal_RequestRoom_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/internalgrpc.proto",
}
